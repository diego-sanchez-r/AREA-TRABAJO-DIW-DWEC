...
function comprobarCartas(e) {
    ...
    if (kebab_pulsado != null) {
        ...
        if (kebabValor1 != kebabValor2 & kebabValor2 > 0) {
            ...
            celdaImagen2.innerHTML = "<img src='kebabs/kebab" + celdaImagen2.getAttribute('value') + ".jpg' class='imagen'>";
        ...
        // Comprobamos que los valores son idénticos (se han acertado las cartas)
            ...
            // A cada celda le añadimos el borde rojo y le quitamos el listener de click
            ...
            if (parseInt(contador_puntos.textContent) == 6) {
                ...
                // Quitamos el borde a todas las celdas y les volvemos a añadir el listener
...
// Comprobamos si existe la cookie del idioma
